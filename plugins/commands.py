...
from codewithshubham.utils.file_properties import get_name, get_hash, get_media_file_size
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('ᴅᴇᴠᴇʟᴏᴘᴇʀ', url=f'https://t.me/SHubham_X_official')
            ],[
